...
export default {
  ...
  methods: {
    ...
    getResidentsOptions() {
      const path = 'http://18.231.124.87:7011/users/all_residents_options';
      axios.get(path)
        .then((res) => {
    ...
    getResidentsOfHouseOptions() {
      const path = 'http://18.231.124.87:7011/users/residents_of_house_options';
      const payload = {
    ...
    getHouse(payload) {
      const path = 'http://18.231.124.87:7011/houses/select_house';
      axios.post(path, payload)
        .then((res) => {
    ...
    registerResident(payload) {
      const path = 'http://18.231.124.87:7011/users/set_new_resident';
      axios.post(path, payload)
        .then((res) => {
    ...
    addResident(payload) {
      const path = 'http://18.231.124.87:7011/users/add_new_resident';
      axios.post(path, payload)
        .then((res) => {
    ...
    removeResidentFromHouse(payload) {
      const path = 'http://18.231.124.87:7011/users/remove_resident_house';
      axios.post(path, payload)
        .then((res) => {
    ...
    setCondPrice(payload) {
      const path = 'http://18.231.124.87:7011/houses/set_price';
      axios.post(path, payload)
        .then((res) => {
    ...
    applyFine(payload) {
      const path = 'http://18.231.124.87:7011/houses/apply_fine';
      axios.post(path, payload)
        .then((res) => {
